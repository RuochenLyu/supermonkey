...
class Popup extends React.Component {
  ...
  render() {
    ...
    const video = data.video ? (
      <iframe
        frameBorder="0"
        src={`//v.qq.com/txp/iframe/player.html?vid=${data.video}&autoplay=true&mini=true&disableplugin=IframeBottomOpenClientBar,IframeEndRecommend,IframePauseRecommend,IframeRelateRecommend`}
