...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Index, [{
    ...
    value: function componentDidMount() {
      this.fetch("北京市"); // let boxId = localStorage.getItem("supermonkey/boxId") * 1;
      // const currentCity =
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_9___default()("/static/".concat(city, ".json"));
...
//# sourceMappingURL=index.js.ea2078daef519766b66e.hot-update.js.map